...
type
  TFrame_FontAwesomeIcons = class(TFrame)
...
procedure TFrame_FontAwesomeIcons.btnBackClick(Sender: TObject);
begin
  lblTitle.Text := 'https://fontawesome.com/icons';
...
procedure TFrame_FontAwesomeIcons.FrameResized(Sender: TObject);
