// Look at https://github.com/mbirabhadra/ColorRecHelper/blob/master/ColorRecHelper.pas
unit RCP.Conversion;
...
procedure XYZtoRGB(X, Y, Z: Single; out R, G, B: Double); overload;
...
procedure XYZtoRGB(X, Y, Z: Single; out R, G, B: Double); //Doesn't work
begin
...
procedure XYZtoRGB(X, Y, Z: Single; out aColor: TAlphaColor); //Doesn't work
var
  R, G, B: Byte;
begin
